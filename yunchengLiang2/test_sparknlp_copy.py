...
class BoldChatETL:
    ...
    def __extract_cus_msg_spark(self, boldchat_df): 
        ...
        nlp_pipeline = Pipeline(
            stages=
            [documentAssembler, documentNormalizer1, documentNormalizer2,documentNormalizer3, documentNormalizer4,  tokenizer,  lemmatizer, normalizer1, stopwords_cleaner, stopWords, normalizer2, finisher]
        )
...
wir_ser_spark.select("session_id","clean_text").orderBy(desc("session_id")).show(truncate = False)
